...
const SUGGESTIONS: Record<number, string> = {
  401: "Check your token: twenty-cli auth test (and TWENTY_BASE_URL for self-host)",
  403: "Insufficient permissions. Check your API key role/scopes.",
  404: "Resource not found. Verify the ID.",
  429: "Rate limited (Twenty ~100 req/min). Wait and retry.",
